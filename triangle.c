...
void drawTriangle(unsigned char input_image[BMP_WIDTH][BMP_HEIGTH][BMP_CHANNELS], int x, int y, int size) {
  int currX = x;
  int endX = x + size;
...
void triforce(unsigned char input_image[BMP_WIDTH][BMP_HEIGTH][BMP_CHANNELS], int x, int y) {
  int size = 8;
  //bottom right
